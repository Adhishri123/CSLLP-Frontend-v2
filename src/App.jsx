...
export default function App() {
  ...
  if (!user) {
    return (
      <Router>
        <Routes>
          {/* ✅ Offer acceptance is PUBLIC - no login required */}
          <Route path="/offer-accept" element={<OfferAcceptancePage />} />
  ...
  // ✅ User is logged in - render protected routes with Layout
  return (
    <AuthProvider>
      <Router>
      {/* 🔴 WRAP ALL ROUTES WITH LAYOUT COMPONENT */}
        <Layout user={user} onLogout={handleLogout}>
          <Routes>
            {/* ✅ Move offer-accept OUTSIDE Layout - it should be standalone */}
            {/* This route is now handled above when user is not logged in */}
